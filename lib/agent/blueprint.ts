...
export const DEFAULT_BLUEPRINT: BlueprintRow = {
  allowed_sources: ["transcript", "client_contact", "template", "scope_of_work", "lead_inquiry"],
  permitted_actions: ["draft_recap", "draft_task_list", "draft_follow_up",
    ...
    "draft_invoice", "draft_collections_reminder", "draft_review_request", "draft_lead_reply"],
